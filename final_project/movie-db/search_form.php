...
<body>
	...
	<div class="container">
		<div class="row">
			<h1 class="text col-12 mt-4 mb-4">DVD Search Form</h1>
		</div> <!-- .row -->
	</div> <!-- .container -->
		...
		?>
				...
				<form action="search_results.php" method="GET">
					...
					<div class="form-group row">
						<label for="title-id" class="text col-sm-3 col-form-label text-sm-right">DVD Title:</label>
						<div class="col-sm-9">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="text form-check form-check-inline">
					...
					<div class="form-group row">
						<label for="date-id" class="text col-sm-3 col-form-label text-sm-right">Release Date:</label>
						<div class="col-sm-9">
							<div class="row">
								<div class="col">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9 mt-2">
							<button type="submit" class="text button-details btn btn-primary">Search</button>
							<button type="reset" class="text button-details btn-light">Reset</button>
						</div>
					</div> <!-- .form-group -->
